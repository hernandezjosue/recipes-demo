...
MIDDLEWARE = [
    ...
    'whitenoise.middleware.WhiteNoiseMiddleware',  # <-- añadir justo después de SecurityMiddleware
...
# Opcional pero recomendable: que WhiteNoise sirva archivos comprimidos y con manifest
